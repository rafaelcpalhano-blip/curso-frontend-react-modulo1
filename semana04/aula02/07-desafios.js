//DESAFIO 1
/*
const orders = [20, 45, 18]

const ordersDelivery = orders.map((order) => {
  return order + 7;
});

console.log(orders);
console.log(ordersDelivery); // [27, 52, 25]
*/
...
const messageGuests= guests.map((guest) => {
  return "Convite para: " + guest;
});

console.log(guests);
console.log(messageGuests); // ["Olá Ana, seja bem-vindo(a)!", "Olá Bruno, seja bem-vindo(a)!", "Olá Carla, seja bem-vindo(a)!"]
*/
...
const biggerFlights = flights.filter((above800) => {
  return above800 >= 800;
});
...
const discount10 = biggerFlights.map((price) => {
  return price * 0.9;
});

console.log(biggerFlights);
